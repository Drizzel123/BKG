...
class DataFetcher extends Thread{
	...
	DataFetcher(String ontology, Controller controller)
	{
		...
		url="http://dbpedia.org/sparql?default-graph-uri=http%3A%2F%2Fdbpedia.org&query=SELECT+*+%7B%3Fs+a+dbo%3A"+ontology+".+%3Fs+dbo%3Aabstract+%3Fabs.+FILTER%28lang%28%3Fabs%29%3D%22en%22%29%7D&format=application%2Fsparql-results%2Bjson&CXML_redir_for_subjs=121&CXML_redir_for_hrefs=&timeout=30000&debug=on&run=+Run+Query+";
	}
